...
The master key must contain at least 32 bytes generated by a cryptographically secure random number generator. It must be mounted as a file readable by Traefik and must not be placed in Docker labels or committed to source control.
